...
While other factors may influence the overall health of giant kelp, the moderate correlation between temperature and frond elongation rates suggests that understanding changes in temperature and overall climate will be a significant factor in monitoring giant kelp growth. Continuing to monitor this relationship will be crucial to understanding how populations of giant kelp and their surrounding ecosystems are impacted by climate change. Restoring these populations may also rely on tactics such as growing kelp in controlled conditions or reintroducing them at cooler times during the year.
...
To analyze the strength of the relationship between temperature and giant kelp frond elongation rate, I used both a Pearson's r correlation test and a Spearman's $\rho$ correlation test.

The results of both the Pearson's correlation coefficient test and the Spearman's rank correlation coefficient test would have led me to reject the null hypothesis that there is no correlation between kelp frond elongation rates and temperature, and alternatively determine that there is a moderate negative correlation between the two variables ((Pearson's r = -0.69, t(30) = -5.2, p \< 0.001, $\alpha$ = 0.05; Spearman's $\rho$ = -0.69, S = 9216, p \< 0.001, $\alpha$ = 0.05).

Both tests result in the same value for the correlation coefficient because both of the variables being tested meet the assumptions of the Pearson's r and the Spearman's $\rho$.
...
![](images/draftofaffectivevisualization-01.png)\
...
![](images/Screen%20Shot%202026-05-26%20at%209.24.10%20PM-01.png)
